...
def generate_launch_description():
    ...
    lifecycle_nodes = ['velocity_smoother']
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'config', 'velocity_smoother_params.yaml'),
    ...
    declare_autostart_cmd = DeclareLaunchArgument(
        'autostart',
        default_value='true',
        description='Automatically startup the velocity smoother',
    )
