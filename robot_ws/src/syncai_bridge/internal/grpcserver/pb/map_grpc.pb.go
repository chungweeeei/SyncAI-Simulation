...
const (
	MapService_GetMap_FullMethodName = "/bridge.MapService/GetMap"
)
...
func (c *mapServiceClient) GetMap(ctx context.Context, in *GetMapRequest, opts ...grpc.CallOption) (*MapResponse, error) {
...
func (UnimplementedMapServiceServer) GetMap(context.Context, *GetMapRequest) (*MapResponse, error) {
