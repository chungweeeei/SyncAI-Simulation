...
const (
	CommandService_SendCommand_FullMethodName = "/bridge.CommandService/SendCommand"
)
...
func (c *commandServiceClient) SendCommand(ctx context.Context, in *CommandRequest, opts ...grpc.CallOption) (*CommandResponse, error) {
...
func (UnimplementedCommandServiceServer) SendCommand(context.Context, *CommandRequest) (*CommandResponse, error) {
...
var CommandService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bridge.CommandService",
