...
> Vendored from [mich1342/ros2_laser_scan_merger](https://github.com/mich1342/ros2_laser_scan_merger) (commit `fa630e2`, branch `foxy`). Locally ported to ROS 2 Humble/Jazzy and extended with a `filter_footprint` (PolygonStamped) visualization. Maintained in-tree from this point — upstream is no longer tracked.
